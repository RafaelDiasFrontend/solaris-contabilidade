<template>
  <div class="">
    <h1 class="text-left d-none">Contabilidade e Consultoria no Guarujá</h1>
    <p class="d-none">Contabilidade e Consultoria no Guarujá</p>
    <HeroImgFull />
...
export default {
    ...
    return {
      ...
      link: [
        {
          rel: "canonical",
          href: "http://solariscontabilidade.com.br",
        },
      ],
      meta: [
        {
  ...
  data() {
    return {     
      ...
      image: "https://solaris-contabilidade-andre.s3.amazonaws.com/solaris_og.jpg",
  ...
  async asyncData({ $axios }) {
    try {
      ...
      const [testResponse, clientsResponse] = await Promise.all([
        testimonials,      
        clients,
      ]);
      console.log([testResponse, clientsResponse]);
      return {
