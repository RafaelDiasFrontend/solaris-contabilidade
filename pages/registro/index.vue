    ...
    <v-container>
      <v-row justify="center" class="login-grid">
        <v-col cols="12" xs="8" sm="8" md="7" lg="6" xl="4">
          <v-card elevation="11" class="login-card reg-mg">
            <h2 class="h2 font-weight-bold text-center text-uppercase white--text py-5">
              Registro
            </h2>
            <v-form
              action=""
...
.login {
  ...
  background-image: linear-gradient(
      295deg,
      rgba(29, 31, 34, 0.164) 0%,
      rgba(61, 92, 124, 0.089) 0%,
      rgba(26, 24, 27, 0.151) 100%,
      rgba(46, 46, 46, 0.342) 100%
    ),
    url("~assets/imagens/login/background_login.jpg");
